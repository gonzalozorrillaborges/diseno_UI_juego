...
const animation_MenuToMain = () => {
    ...
    console.log("anima del menu al juego");
    // Selecciona elementos a animar
    ...
    //Hace falta alguna promesa o algún callback? para ejecutar las siguientes acciones
...
/*---  Creamos la animación para quitar el popup y continuar  ----*/ 
...
/*---- Aqui ponemos la animación del modal de confirmación para salir del juego ---- */
...
const animation_game_out = (getTo) => {
    animation_confirmOut(getTo);
    animation_PopupContinue(getTo);

    console.log("Salgo a la pantalla principal");
